...
JSON    - format usor de interschimbare a datelor
        - un standard derivat din JavaScript
        - JavaScript Object Notation (notatia JavasScript)

Modulul json permite lucrul cu tipul de fisiere JSON (built-in in Python)
Documentatie oficiala:
    https://docs.python.org/3/library/json.html#encoders-and-decoders
JSON: https://www.json.org/json-ro.html
JSON este construit pe baza a doua structuri:
1. o colectie de perechi nume/valoare (obiect)
2. o lista de valori (un tablou/array)

Lucrul cu fisiere JSON presupune:
1. Citirea / Deserializare / Decodificare
